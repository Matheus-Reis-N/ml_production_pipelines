...
def train_ada_clf_with_randomgridsearch(x_train, y_train, x_test, tags):
    """
    Treina um modelo de AdaBoost e exibe o melhor hiperparâmetro e o melhor score.
    ...
    # Definindo o espaço de hiperparâmetros para o Ada Boost Classifier
    param_dist = {
    ...
    randomized_search = RandomizedSearchCV(estimator=clf_ada,
